...
import AdminPanelManagement from "./components/AdminPanelManagement";
...
import PanelReviewPage from "./components/PanelReviewPage";
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/admin/*" element={<RoleProtectedRoute allowedRoles={["Admin"]}><AdminLayout /></RoleProtectedRoute>}>
            ...
            <Route path="panels" element={<AdminPanelManagement />} />
          ...
          <Route path="/teacher/*" element={<RoleProtectedRoute allowedRoles={["Admin","Teacher", "Coordinator"]}><TeacherLayout /></RoleProtectedRoute>}>
            ...
            <Route path="panel-review" element={<PanelReviewPage />} />
          </Route>
